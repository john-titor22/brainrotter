...
CATALOG: list[Voice] = [
    ...
    # --- Darija (Moroccan) ---------------------------------------------
    Voice(name="ar-MA-JamalNeural", label="Jamal — دارجة مغربية، راجل",
          gender="male", language="ary",
          tags=["narrator", "hype", "reddit", "ai_brainrot", "storytime"],
          default_rate=1.08),
    Voice(name="ar-MA-MounaNeural", label="Mouna — دارجة مغربية، مرا",
          gender="female", language="ary",
          tags=["storytime", "reddit", "hype", "calm"], default_rate=1.1),
]
